...
router.register('movies', views.viwsets_movie)
router.register('reservations', views.viwsets_reservation)
...
urlpatterns = [
    ...
    path('rest/generics/', views.generics_list.as_view()),
     ...
     #6.2 GET PUT DELETE from rest framework class based view genircs
